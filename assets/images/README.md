...
### 1) `kql_query_results_1_find_want_to_cry.png`
- Source query: [1 Find Wannacry Files](../kql_queries/01_find_want_to_cry_files.kql)
...
### 2) `kql_query_results_2_process_investigation.png`
- Source query: [3 Correlate File Activity by Process](../kql_queries/03_file_activity_by_process.kql)
...
### 3) `kql_query_results_3_registry_exclusions.png`
- Source query: [6 Check Defender Exclusions Paths](../kql_queries/06_defender_exclusions_paths.kql)
...
### 4) `kql_query_results_4_network_validation.png`
- Source query: [7 Validate Network Connections](../kql_queries/07_network_connections.kql)
